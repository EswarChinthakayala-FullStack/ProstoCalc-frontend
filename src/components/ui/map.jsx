...
const DefaultLoader = () => (
  <div className="absolute inset-0 flex items-center justify-center">
    <div className="flex gap-1">
      <span className="size-1.5 rounded-md bg-muted-foreground/60 animate-pulse" />
      <span
        className="size-1.5 rounded-md bg-muted-foreground/60 animate-pulse [animation-delay:150ms]" />
      <span
        className="size-1.5 rounded-md bg-muted-foreground/60 animate-pulse [animation-delay:300ms]" />
    </div>
  </div>
);
...
function DefaultMarkerIcon() {
  return (
    <div
      className="relative h-4 w-4 rounded-md border-2 border-white bg-blue-500 shadow-lg" />
  );
}
